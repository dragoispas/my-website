        ...
        <div className="education-stack">
          {educationData.map(educationEntry => 
            <div className="education-entry-wrapper">
              <div className="education-entry" key={educationEntry.title}>
                <div className="education-entry-left">
                  <h3>{educationEntry.title}</h3>
                  <p className="muted">{educationEntry.institution}</p>
                </div>
                <h3 className="accent">{educationEntry.date}</h3>
              </div>
